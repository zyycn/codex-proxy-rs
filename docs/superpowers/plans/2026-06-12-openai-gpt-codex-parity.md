...
- [x] Run: `cargo test --test admin_accounts_route_test`
- [ ] Write failing tests for manual add, quota fetch, health check, cookie get/set/delete, remaining import/export, API key disable/delete.
