...
fn source_tree_should_match_frozen_machine_manifest() {
    ...
    let mut expected = vec![
        ...
        "src/lib.rs",
        "src/openai/auth.rs",
        "src/openai/chat_completions/mod.rs",
        "src/openai/chat_completions/http.rs",
        "src/openai/chat_completions/request.rs",
        "src/openai/chat_completions/response.rs",
        "src/openai/error.rs",
        "src/openai/http.rs",
...
fn test_tree_should_match_frozen_rust_mirror() {
    ...
    let mut expected = vec![
        ...
        "tests/openai/chat_completions/mod.rs",
        "tests/openai/chat_completions/http.rs",
        "tests/openai/chat_completions/request.rs",
        "tests/openai/chat_completions/response.rs",
