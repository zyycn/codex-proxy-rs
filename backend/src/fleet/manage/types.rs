...
pub(super) struct ManualCreateTokens {
    ...
    pub(super) claims: crate::fleet::refresh::ManualAccountClaims,
}
...
pub(super) struct ResolvedImportTokens {
    pub(super) access_token: String,
    pub(super) refresh_token: Option<String>,
    pub(super) claims: Option<crate::fleet::refresh::ManualAccountClaims>,
}
...
pub(super) fn stored_to_admin_metadata(s: crate::fleet::store::StoredAccount) -> ManagedAccount {
    ManagedAccount::from(crate::fleet::store::StoredAccountMetadata {
        id: s.id,
        email: s.email,
