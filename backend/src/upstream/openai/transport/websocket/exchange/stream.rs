...
pub(in crate::upstream::openai::transport::websocket) struct WebSocketStreamPoolReturn {
    pub(in crate::upstream::openai::transport::websocket) lease: WebSocketPoolLease,
    pub(in crate::upstream::openai::transport::websocket) created_at: tokio::time::Instant,
...
pub(in crate::upstream::openai::transport::websocket) fn stream_websocket_response(
