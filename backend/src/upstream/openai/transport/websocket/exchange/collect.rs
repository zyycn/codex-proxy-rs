...
use crate::upstream::openai::{
    protocol::{events, sse::SseEventDecoder},
    transport::response_meta,
};
...
pub(in crate::upstream::openai::transport::websocket) struct CollectedWebSocket {
    pub(in crate::upstream::openai::transport::websocket) exchange: CodexWebSocketExchange,
    pub(in crate::upstream::openai::transport::websocket) websocket: PumpedWebSocket,
    pub(in crate::upstream::openai::transport::websocket) metadata:
        CodexWebSocketConnectionMetadata,
    pub(in crate::upstream::openai::transport::websocket) continuation: WebSocketContinuationState,
    pub(in crate::upstream::openai::transport::websocket) terminal: WebSocketTerminalKind,
}

pub(in crate::upstream::openai::transport::websocket) async fn collect_websocket_response(
