...
use crate::codex::protocol::events::extract_sse_usage;
pub use crate::codex::protocol::responses::{CodexCompactRequest, CodexResponsesRequest};
...
use self::opening::write_websocket_audit_artifact_from_env;
pub use self::pool::{CodexWebSocketPool, CodexWebSocketPoolConfig, CodexWebSocketPoolKey};
...
pub struct CodexBackendResponse {
    ...
    /// 从 SSE 中提取出的最终 usage。
    pub usage: Option<crate::codex::protocol::events::TokenUsage>,
    /// 响应头里的最新 turn state。
