...
pub struct AccountRepository {
    ...
    pub(super) secret_box: SecretBox,
}
...
pub(crate) fn parse_optional_rfc3339(
    value: Option<String>,
) -> AccountRepositoryResult<Option<DateTime<Utc>>> {
    value.as_deref().map(parse_rfc3339).transpose()
}

pub(crate) fn parse_rfc3339(value: &str) -> AccountRepositoryResult<DateTime<Utc>> {
...
pub(crate) fn optional_positive_i64_to_u64(value: Option<i64>) -> Option<u64> {
    value
