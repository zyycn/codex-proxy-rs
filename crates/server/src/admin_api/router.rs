...
use crate::admin_api::accounts::{
    account_quota, accounts, auth_callback, auth_code_relay, auth_device_login, auth_device_poll,
    auth_login_start, auth_logout, auth_status, batch_delete_accounts, batch_update_account_status,
    create_account, delete_account, delete_account_cookies, export_accounts, get_account_cookies,
    health_check_accounts, import_accounts, import_cli_account, quota_warnings, refresh_account,
    reset_account_usage, set_account_cookies, update_account_label, update_account_status,
};
use crate::admin_api::client_keys::{
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/api/admin/accounts/import-cli", post(import_cli_account))
