...
use codex_proxy_adapters::sqlite::session_affinity::{
    SqliteSessionAffinityStore, SqliteSessionAffinityStoreResult,
};
...
impl SessionAffinityCleanupTask {
    ...
    /// 执行一次清理。
    pub async fn cleanup_once(&self) -> SqliteSessionAffinityStoreResult<u64> {
