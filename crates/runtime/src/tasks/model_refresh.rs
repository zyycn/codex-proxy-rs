...
use codex_proxy_core::{
    accounts::{model::Account, ports::AccountStore},
    models::service::{ModelService, ModelServiceError},
};
...
impl ModelRefreshTask {
    ...
    async fn refresh_once(
        &self,
    ) -> Result<codex_proxy_core::models::service::ModelRefreshResult, ModelServiceError> {
