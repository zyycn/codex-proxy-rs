...
impl ImplicitResumeSnapshot {
    /// 捕获当前请求中隐式续接会改写的字段。
    pub fn capture(request: &crate::protocol::codex::responses::CodexResponsesRequest) -> Self {
        Self {
    ...
    /// 恢复隐式续接前的请求字段。
    pub fn restore(self, request: &mut crate::protocol::codex::responses::CodexResponsesRequest) {
