...
const fallbackPalettes = [
  ...
  'bg-cp-normal-bg text-cp-normal-text shadow-cp-input',
  'bg-cp-warning-bg text-cp-warning-text shadow-cp-input',
]

const usageTierPalettes: Record<string, string> = {
  pro: 'bg-cp-plan-pro-bg text-cp-plan-pro-text shadow-cp-input',
  prolite: 'bg-cp-plan-prolite-bg text-cp-plan-prolite-text shadow-cp-input',
}
