...
export const fieldLabelClass = 'text-[11px] leading-none font-bold text-cp-muted-text'
export const fieldValueBaseClass
  = 'mt-1.5 mb-0 min-w-0 truncate text-[12px] leading-none font-bold text-cp-primary'
