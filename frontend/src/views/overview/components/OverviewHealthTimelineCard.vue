...
import type { HealthTimeline, HealthTimelinePoint } from '@/views/overview/model/health'
...
import { formatHealthCount, healthLegend, healthReliabilityValueClass, healthStatusMeta } from '@/views/overview/model/health'
import OverviewHealthTimelinePointPopover from './OverviewHealthTimelinePointPopover.vue'
      ...
      <div>
        ...
        >
          ...
          <div class="w-72 overflow-hidden rounded-cp-lg">
            <OverviewHealthTimelinePointPopover v-if="activePoint" :point="activePoint" />
          </div>
        </BasePopover>
      </div>
    </template>
