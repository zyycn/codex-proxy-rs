...
import type { MetricCardView, MetricTone } from '@/views/overview/model/display'
...
import { metricToneIconClasses, metricToneValueClasses } from '@/views/overview/model/display'
import OverviewAnimatedMetricValue from './OverviewAnimatedMetricValue.vue'
  ...
  <BaseCard as="article" padding="compact" class="relative h-38.5 w-full">
    ...
    <div class="mt-3.25 flex h-7.75 items-end gap-2">
      <strong class="font-mono text-[28px] leading-[1.05] font-heavy tabular-nums text-cp-text">
        <OverviewAnimatedMetricValue :value="metric.value" :raw-value="metric.valueRaw" :formatter="metric.valueFormatter" />
      </strong>
      <i
