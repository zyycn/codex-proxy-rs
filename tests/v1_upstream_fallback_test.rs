...
const AFTER_429_SSE: &str = include_str!("fixtures/v1_responses_after_429.sse");
const STREAM_AFTER_429_SSE: &str = include_str!("fixtures/v1_responses_stream_after_429.sse");
const AFTER_402_SSE: &str = include_str!("fixtures/v1_responses_after_402.sse");
const AFTER_403_SSE: &str = include_str!("fixtures/v1_responses_after_403.sse");
const AFTER_CLOUDFLARE_403_SSE: &str =
    include_str!("fixtures/v1_responses_after_cloudflare_403.sse");
const AFTER_REFRESH_SSE: &str = include_str!("fixtures/v1_responses_after_refresh.sse");
const STREAM_AFTER_REFRESH_SSE: &str =
    include_str!("fixtures/v1_responses_stream_after_refresh.sse");
