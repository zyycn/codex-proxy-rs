...
const ERROR_EVENT_SSE: &str = include_str!("fixtures/v1_responses_error_event.sse");
const FAILED_EVENT_SSE: &str = include_str!("fixtures/v1_responses_failed_event.sse");
const STREAM_ERROR_EVENT_SSE: &str = include_str!("fixtures/v1_responses_stream_error_event.sse");
const STREAM_FAILED_EVENT_SSE: &str = include_str!("fixtures/v1_responses_stream_failed_event.sse");
