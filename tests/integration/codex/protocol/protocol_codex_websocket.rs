...
fn codex_websocket_response_create_payload_text_should_preserve_canonical_field_order() {
    ...
    let payload =
        codex_proxy_rs::codex::protocol::websocket::websocket_response_create_payload_text(
            &request,
        )
...
fn codex_websocket_parity_diff_should_report_header_payload_and_error_differences() {
    let current = codex_proxy_rs::codex::protocol::websocket::WebSocketAuditArtifact {
    ...
    let reference = codex_proxy_rs::codex::protocol::websocket::WebSocketAuditArtifact {
